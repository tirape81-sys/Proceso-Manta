...
function saveAntimicotico() {
    ...
    const record = {
        ...
        const payload = {
            fecha: dateStr,
            bin1_ini: record.bin1_ini,
            bin2_ini: record.bin2_ini,
            bin3_ini: record.bin3_ini,
            bin1_fin: record.bin1_fin,
            bin2_fin: record.bin2_fin,
            bin3_fin: record.bin3_fin,
            bin1_add: record.bin1_add,
            bin2_add: record.bin2_add,
            bin3_add: record.bin3_add,
            total_ini: record.total_ini,
            total_fin: record.total_fin,
            cant_agregada: record.cant_agregada,
            trucks_rcvd: record.trucks_rcvd,
            cons_teo: record.cons_teo,
            cons_real: record.cons_real,
            diferencia: record.diferencia,
            bodega: record.bodega,
            realizado_por: record.realizado,
